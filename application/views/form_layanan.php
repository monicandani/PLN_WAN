                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Mulyono</td>
                                            <td>081234567</td>
                                            <td><center> <a class="btn btn-default" href="<?php echo base_url();?>c_main/edit">Edit</a> <button class="btn btn-danger" onclick='delete_user(<?php echo $u->id ?>)' data-toggle="modal" data-target="#myModal">Hapus</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
